...
class TensorBase(torch.nn.Module):
    def __init__(self, aabb, gridSize, device, density_n_comp = 8, appearance_n_comp = 24, app_dim = 27,
        ...
        self.rgb_resblock = AlbedoCompensatePhi()
    ...
    def forward(self, rays_chunk, poseid, filters, white_bg=True, is_train=False, ndc_ray=False, N_samples=-1):
        ...
        despec = spec_map * filters
        rgb_map_pred = despec @ Phi
        rgb_resdual = self.rgb_resblock(despec, Phi)
        ...
        return rgb_map, depth_map, dist_loss, spec_map, Phi, rgb_resdual, rgb_map_pred # rgb, sigma, alpha, weight, bg_weight
