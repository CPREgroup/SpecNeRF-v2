...
def config_parser(cmd=None):
    ...
    parser.add_argument('--dataset_name', type=str, default='blender',
                        choices=['blender', 'llff', 'nsvf', 'dtu','tankstemple', 'own_data', 'synthetic'])
    ...
    parser.add_argument('--observation_channel', type=int, default=3)
    ...
    parser.add_argument('--ssf_model_components',type=int,default=3)
